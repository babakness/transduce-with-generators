...
function chunk(num) {
    return function (inputs) {
        var arr, inputs_4, inputs_4_1, input, e_5_1;
        var e_5, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    ...
                    _b.label = 2;
                case 2:
                    if (!!inputs_4_1.done) return [3 /*break*/, 5];
...
function filterWithIndex(fn) {
    var index = 0;
    return function (inputs) {
        var inputs_6, inputs_6_1, input, e_7_1;
        var e_7, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, 6, 7]);
                    inputs_6 = __values(inputs), inputs_6_1 = inputs_6.next();
                    _b.label = 1;
                case 1:
                    if (!!inputs_6_1.done) return [3 /*break*/, 4];
                ...
                case 6:
                    try {
                        if (inputs_6_1 && !inputs_6_1.done && (_a = inputs_6.return)) _a.call(inputs_6);
                    }
